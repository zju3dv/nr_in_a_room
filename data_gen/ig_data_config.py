...
WIMR2PC = {
    ...
    "mirror": ["mirror", "mirror:outside room", "outside room mirror"],
    "window": [
        "window",
        "window:outside",
        "window:outside room",
    ...
    "door": ["door", "doorway", "door non-4pt-polygon"],
    "cabinet": [
        "cabinet",
        "cabinet:outside",
    ...
    "tv": ["tv", "TV", "tv:outside room ", "TV set"],
}
...
IG2PC = {
    ...
    "bottom_cabinet_no_top": "cabinet",  # 'top_cabinet': 'cabinet'
}
...
colorbox_path = "data_gen/igibson_colorbox.mat"
igibson_colorbox = np.array(sns.hls_palette(n_colors=len(IG59CLASSES), l=0.45, s=0.8))
