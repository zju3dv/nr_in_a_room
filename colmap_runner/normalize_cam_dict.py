...
def get_tf_cams(cam_dict, target_radius=1.0):
    cam_centers = []
...
def normalize_cam_dict(
    ...
    out_cam_dict_file,
    target_radius=1.0,
    in_geometry_file=None,
    out_geometry_file=None,
):
...
if __name__ == "__main__":
    in_cam_dict_file = ""
    out_cam_dict_file = ""
    normalize_cam_dict(in_cam_dict_file, out_cam_dict_file, target_radius=1.0)
