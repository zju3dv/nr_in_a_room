...
if __name__ == "__main__":
    ...
    if args.obj_in_arkit_coord:
        # rotate mesh
        mesh = o3d.io.read_triangle_mesh(args.obj_in_arkit_coord)
        mesh.rotate(rotation, center=(0, 0, 0))
    elif args.obj_in_aligned_coord:
        mesh = o3d.io.read_triangle_mesh(args.obj_in_aligned_coord)
        # TODO: hard code scale
        mesh.scale(2, center=(0, 0, 0))
    ...
    for idx in tqdm(range(len(all_image_files))):
        ...
        # normal_map = cv2.GaussianBlur(normal_map, ksize=(9, 9), sigmaX=1.5)
        # render_normal_map
        # normal_map = render.render(scene, RenderFlags.FACE_NORMALS)[1]
        # import ipdb
        # ipdb.set_trace()
